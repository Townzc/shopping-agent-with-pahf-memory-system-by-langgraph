...
| 数据类型 | 示例 |
| --- | --- |
| 商品分类 | 家居、数码3C、服饰、美妆个护 |
| 商品 | `P1002` 声波 X 主动降噪耳机，价格 899 元 |
| SKU | `P1002-BLK` 深空灰，`P1002-WHT` 云白 |
| 顾客 | `demo-user`、`u1001` |
| 订单 | `SO20260012`、`SO20260027`、`SO20260041`、`SO20260050` |
...
| --- | --- | --- | --- | --- |
| TC-SHOP-001 | 查询商品分类 | GET `/api/v1/shop/categories` | 返回家居、数码3C、服饰、美妆个护 | P0 |
